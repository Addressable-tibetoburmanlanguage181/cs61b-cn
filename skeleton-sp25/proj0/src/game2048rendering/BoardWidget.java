...
class BoardWidget extends Pad {
    ...
    /** 返回NEXTTILES中新创建的或由当前方块合并产生的所有方块列表。 */
    ...
    private void tick() {
        try {
            ...
            assert false : "内部错误：意外中断";
        }
    }

    /** 在BLOOMINGTILES中的方块上创建绽放效果。 */
    ...
    /** 将方块移动到新位置，并从MODEL中保存新的方块集合，
     *  假设MODEL反映了所有移动完成后的下一个状态。 */
    ...
    /** 方块向下一位置移动的距离，以行和列为单位。 */
    private float _distMoved;
    /** _bloomingTiles中方块边缘的增量。 */
    private int _bloom;
